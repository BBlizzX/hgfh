    ...
    startButton.addEventListener('click', function () {
      ...
      if (navigator.geolocation) {
        navigator.geolocation.watchPosition(function (position) {
          ...
          const targetLat = 49.583346;
          const targetLon = 34.539731;
          ...
          const hints = [
            {lat: 49.583161, lon: 34.539879, text: 'Йдіть направо до маленьких сходів'},
            {lat: 49.583233, lon: 34.539804, text: 'Підніміться по сходам на другий поверх'},
            {lat: 49.583231, lon: 34.539819, text: 'Поверніть направо та йдіть до першого повороту'}
          ];
